...
public class PdfService {
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph title2 = new Paragraph("\n DMV Store", new Font(Font.HELVETICA, 20, Font.BOLD));
        title2.setAlignment(Element.ALIGN_CENTER);
        Paragraph title3 = new Paragraph("So dien thoai: 0339263495"+
                "\nEmail: dmvstoresneaker@gmail.com" +
                "\nDia chi: So 67, No Ban, Van Tao, Thuong Tin, Ha Noi\n------------------------------------------",
        ...
        Paragraph boder = new Paragraph("\n------------------------------------------\n"
                + "DMV store CAM ON VA HEN GAP LAI KHACH HANG");

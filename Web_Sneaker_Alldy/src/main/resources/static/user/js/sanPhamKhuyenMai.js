var app = angular.module("sanPhamKhuyenMai-app", [])
app.controller("sanPhamKhuyenMai-ctrl", function ($scope, $http) {
    ...
    $http.get("/san-pham/sp-khuyen-mai").then(r => {
    ...
    $scope.getAll = function (pageNumber) {
        ...
        $http.get("/san-pham/sp-khuyen-mai?pageNumber="+$scope.pageNumber).then(r => {
                $scope.products = r.data.content;
                // $scope.filterData = {}
            }).catch(e => console.log(e))
    }
            ...
            if (response.data) {
                ...
                $http.get("/cart/find-all-sp")
                    .then(function(r) {
                        console.log(r.data);
                        $scope.cart = r.data;
                        console.log("soLuong khuyen mai:", $scope.cart);
                    })
                    .catch(function(e) {
                        console.log(e);
                    });
